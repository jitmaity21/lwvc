                                        ...
                                        <table class="w-full">
                                            <tbody class="text-sm font-normal text-gray-700">
                                                ...
                                                <tr v-if="!sundayinputs.length">
                                                    ...
                                                    <td class="px-4 py-4"><span class="px-2"><input type='checkbox' @click='check(k,"sun",$event)' v-model="isCheck" ></span>SUN</td>
                                                    ...
                                                    <td class="px-4 py-4"><a href="javascript:void(0);" @click="showDropdown()">
                                                 ...
                                                 <tr v-for="(input,k) in sundayinputs":key="k">
                                                    ...
                                                    <td class="px-4 py-4" v-if="k==0"><span class="px-2"><input type='checkbox' @click='check(k,"sun",$event)' v-model="isCheck" ></span>SUN</td>
                                                    <td class="px-4 py-4" v-if="k>0">&nbsp;</td>
                                                    <td class="px-4 py-4 text-gray-400">
                                                    <input
                                                                                type="time"
                                                                                format="hh:mm"
                                                                                class="shadow-sm bg-gray-50 text-gray-900 sm:text-sm focus:ring-cyan-600 focus:border-cyan-600 p-2.5"
                                                    ...
                                                    <td><a
                                                        ...
                                                        <td class="px-4 py-4" v-if="k==0"><a href="javascript:void(0);" @click="showDropdown('sun')">
                                                        <i class="fa-regular fa-copy"></i>
                                                        </a>
                                                                ...
                                                                <li class="px-1 py-1" v-for="(option, index) in options" :key="index">
                                                                <input type="checkbox" :id="index" :value="option.value" :checked= "option.value == 'sun'"  @click="onCheck(option.value,$event)">
                                                                <label :for="index">{{ option.text }}</label>
                                                                </li>

                                                                <li class="px-1 py-1 butsty"><button @click="onApply('sun')">Apply</button></li>
                                                                </ul>
                                                ...
                                                <!--monday inputs-->
                                                    ...
                                                    <td class="px-4 py-4"><span class="px-2"><input type='checkbox' @click='checkMon(m,"mon",$event)' v-model="isCheckMon" ></span>MON</td>
                                                    <td class="px-4 py-4 text-gray-400">Unavailable</td>
                                                    <td class="px-4 py-4"><a
                                                        href="javascript:void(0);"  @click="
                                                                                    addMondayvalue(
                                                    ...
                                                    <td class="px-4 py-4"><a href="javascript:void(0);" @click="showDropdownMon()">
                                                        <i class="fa-regular fa-copy"></i>
                                                        </a></td>
                                                 ...
                                                 <tr v-for="(input,m) in mondayinputs":key="m">
                                                    ...
                                                    <td class="px-4 py-4" v-if="m==0"><span class="px-2"><input type='checkbox' @click='checkMon(m,"mon",$event)' v-model="isCheckMon" ></span>MON</td>
                                                    ...
                                                    <td><a
                                                        ...
                                                        <td class="px-4 py-4" v-if="m==0"><a href="javascript:void(0);" @click="showDropdownMon('mon')">
                                                        <i class="fa-regular fa-copy"></i>
                                                        </a>
                                                                ...
                                                                <ul class="px-2 py-2 bcolor">
                                                                    <li class="px-1 py-1"><p>Copy Items to</p></li>
                                                                <li class="px-1 py-1" v-for="(option, index1) in options" :key="index1">
                                                                <input type="checkbox" :id="index1" :value="option.value" :checked= "option.value == 'mon'"  @click="onCheckMon(option.value,$event)">
                                                                <label :for="index1">{{ option.text }}</label>
                                                                </li>

                                                                <li class="px-1 py-1 butsty"><button @click="onApplyMon('mon')">Apply</button></li>
                                                                </ul>
           ...
           this.selectedval.forEach((value,index )=>{
            ...
            console.log(value);
                   ...
                   if(value=='mon'){
                    ...
                    console.log("sun");
                        this.mondayinputs.push(this.sundayinputs); 
